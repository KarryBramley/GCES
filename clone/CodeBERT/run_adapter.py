...
def train(args, train_dataset, model, tokenizer):
    ...
    if args.task_id>0:
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0:
                    ...
                    if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                        ...
                        if results['eval_f1']>best_acc:
                            ...
                            # 这里保存参数要用 .encoder.state_dict()
                            torch.save(model_to_save.encoder.state_dict(), output_dir)
        ...
        # 这里保存参数要用 .encoder.state_dict()
        torch.save(model_to_save.encoder.state_dict(), output_model_file)
...
def main():
    ...
    if args.do_train:
        if args.load_model_path is not None:
            ...
            new_state_dict = torch.load(args.load_model_path)
