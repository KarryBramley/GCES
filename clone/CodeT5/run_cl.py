...
def main():
    ...
    # print('*' * 20)
    # print('after!')
    # model = AdapterModel(backbone_model = model,modified_modules=['layer.0','layer.2','[r]encoder\.block\.(\d)+\.layer\.[01]'],bottleneck_dim=128)
    # model.log(delta_ratio=True, trainable_ratio=True, visualization=True)
    # Visualization(model).structure_graph()
