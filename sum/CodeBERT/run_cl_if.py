...
from construct_exemplar import calculate_coefficient
from construct_exemplar_if import construct_exemplars_if
from ewc import *
...
def main():
    ...
    if args.do_train:
        ...
        if 'emr' in args.mode or 'ewc' in args.mode or args.mode in ['hybird']:
            ...
            construct_exemplars_if(model_to_save, args, origin_train_examples, origin_eval_examples, 
                                     tokenizer, device, param_influence, 'ours')
